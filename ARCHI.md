...
**Verified plugin facts** (from the Claude Code plugins reference documentation, plus a local symlink-discovery experiment; the end-to-end `/plugin install` of this repo is not yet exercised in CI):
