...
- One entry per day following the structure and pacing limits in `<FRAMEWORK_ROOT>/skills/holiday-planner/04-itinerary-templates.md` (e.g. max anchor activities/day, rest-day cadence) as defined in the user's profile.
