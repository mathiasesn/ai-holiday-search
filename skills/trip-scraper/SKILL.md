...
for. It has its own fallback chain, authoritative in `.claude/skills/booking-search/SKILL.md`;
...
`.claude/skills/holiday-planner/05-budget-rules.md` for the conversion/labeling policy). Name
